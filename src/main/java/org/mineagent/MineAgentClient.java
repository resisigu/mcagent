...
public final class MineAgentClient {
 ...
 private static boolean hasFood(LocalPlayer p){for(int i=0;i<9;i++){var stack=p.getInventory().getItem(i);if(!stack.isEmpty()&&stack.isEdible())return true;}return false;}
