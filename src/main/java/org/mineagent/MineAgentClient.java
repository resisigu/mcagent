...
public final class MineAgentClient {
 ...
 private static void selectFood(LocalPlayer p){for(int i=0;i<9;i++){var stack=p.getInventory().getItem(i);if(!stack.isEmpty()&&stack.getFoodProperties(p) != null){p.getInventory().selected=i;return;}}}
