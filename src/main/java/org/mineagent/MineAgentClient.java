...
public final class MineAgentClient {
 ...
 private static void selectFood(LocalPlayer p){for(int i=0;i<9;i++){var stack=p.getInventory().getItem(i);if(!stack.isEmpty()&&stack.isEdible()){p.getInventory().setSelectedSlot(i);return;}}}
