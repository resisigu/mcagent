...
public final class MineAgentClient {
 ...
 private record Control(double forward,double strafe,boolean jump,boolean sprint,boolean attack,boolean use,float yaw,float pitch,Integer targetId){static Control empty(){return new Control(0,0,false,false,false,false,Float.NaN,Float.NaN,null);}}
}
